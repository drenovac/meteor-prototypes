  ...
  if (timesheets == null) {
    getRosterInformation(props.sessionID)
      .then((d) => {
        ...
        onData(null, {timesheets: timesheets, navigateLeft, navigateRight,week: week, direction: _direction})
      })
    // .catch((e) => {
    //  alert(`Error fetching roster info : ${e.reason}`)
    // })
  } else{
    onData(null, {week: week, t: week.getTime(), timesheets: timesheets, navigateLeft, navigateRight, direction: _direction})
  }
